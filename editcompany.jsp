	...
	<div id="content">
		...
		<%
			try
			{
				...
				PreparedStatement ps = con.prepareStatement("select * from rangoli_company");
				ResultSet rs = ps.executeQuery();
				out.print("<table border='1'>");
				out.print("<th style='font-family:arial; font-size:15px; color:blue' width='80'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit</th><th style='font-family:arial; font-size:15px; color:blue' width='80'>&nbsp;&nbsp;&nbsp;Remove</th><th style='font-family:arial; font-size:15px; color:blue' width='150'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Category Name</th><th style='font-family:arial; font-size:15px; color:blue' width='150'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Company Name</th>");
				while(rs.next())
				{
					out.print("<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='updatecompany.jsp?catid="+rs.getString("category_name")+"&cmpid="+rs.getString("company_name")+"'><img src='images/pencil.png'></img></a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='removecompany.jsp?catid="+rs.getString("category_name")+"&cmpid="+rs.getString("company_name")+"'><img src='images/cross.png'></img></a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>"+rs.getString("category_name")+"</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>"+rs.getString("company_name")+"</td></tr>");
				} 	
				out.print("</table>");	
				con.close();
			}
